...
|---|---|---|---|
| `v1.24-2026-05-18-QR-LoadedImage-URL.xml` | v1.24 | QR Code Model 2, v5 (37×37) | **First QR + first loaded-image capture.** SymbologyId=`]Q2`, SymbolQuality=100, OverallGrade=A (4/A). Image-load fingerprint: SymbolAngle=360°, ContrastUniformity=−1, MRD=−1. JPEG len=22,260 chars (~16.7 KB raw). Payload has ECI-26 (UTF-8) prefix `\000026` + `https://scanned.page/67645c1593669`. B3 + D3 findings — see CHANGELOG v1.25 scope. |
