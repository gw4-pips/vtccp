...
- [HTTP result delivery](http-result-delivery.md) — DataMan-triggered scans are primary; RFID VeriWedge should capture and report in the background via HTTP/DMST evidence
...
- [Canonical delivery gate](canonical-delivery-gate.md) — VTCCP is not delivered until build, push, and remote SHA/version confirmation all succeed
