...
/// <summary>
/// Correlates ASR-P35U QC callbacks (cbSuccess codes 40=PermaLock, 41=Lock,
/// 42=Unlock; cbError) with an active <c>CheckTagStatus</c> request. SDK 1.3.0
/// normally returns <c>Types.TagStatus</c> synchronously; these callbacks are a
/// fallback and are also retained for complete on-device diagnostics.
///
