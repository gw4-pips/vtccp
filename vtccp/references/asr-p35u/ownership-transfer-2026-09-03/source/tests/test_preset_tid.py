...
def _make_app(cfg: Config | None = None) -> App:
    ...
    app._preset_lbl_var = _Var()

    # Non-tkinter application state used by preset mode transitions.
    app._trigger_mode  = ''
    app._trigger_armed = False
    app._qc_active     = False
    app._reader        = None
    app._last_epcs     = {}
    ...
    app._disarm_trigger           = MagicMock()
    app._stop_reading             = MagicMock()
